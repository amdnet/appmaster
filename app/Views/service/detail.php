                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="btn-group float-right" role="group" aria-label="Basic example">
                            ...
                            <a href="<?= base_url('progress/add/' . $detail->id_service); ?>" type="button" class="btn btn-primary btn-sm"> Tambah Data &nbsp; <i class="fas fa-plus-circle"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
...
<script>
    ...
    <?php require_once(APPPATH . 'views/progress/photo.js'); ?>
