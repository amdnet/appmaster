            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Data Kategori Tipe Mobil</h3>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            <div class="text-center bg-dark p-2">
                <h5 class="modal-title text-white" id="info-header-modalLabel">Tambah Tipe Mobil</h5>
            </div>
            ...
            <div class="modal-body">
                ...
                <form id="add-form" class="pl-2 pr-2">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <label for="tipeMobil"> Mobil: </label>
                            <input type="text" id="tipeMobil" name="tipeMobil" class="form-control" placeholder="Tipe Mobil" required>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="edit-form" class="pl-2 pr-2">
                    <div class="row">
                        <input type="hidden" id="idMobil" name="idMobil" class="form-control">
                        <input type="hidden" id="fullname" name="fullname" class="form-control" value="<?= user()->fullname; ?>">
                    </div>
...
<script>
    ...
    function edit(id_mobil_tipe) {
        $.ajax({
            url: '<?= base_url($controller . '/getOne') ?>',
            type: 'post',
            data: {
                id_mobil_tipe: id_mobil_tipe
            },
            dataType: 'json',
            success: function(response) {
                // reset the form 
                ...
                $("#edit-form #idMobil").val(response.id_mobil_tipe);
                $("#edit-form #tipeMobil").val(response.nama_mobil_tipe);
