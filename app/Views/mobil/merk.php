            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Data Kategori Merk Mobil</h3>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            <div class="text-center bg-dark p-2">
                <h5 class="modal-title text-white" id="info-header-modalLabel">Tambah Merk Mobil</h5>
            </div>
            ...
            <div class="modal-body">
                ...
                <form id="add-form" class="pl-2 pr-2">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <label for="merkMobil"> Mobil: </label>
                            <input type="text" id="merkMobil" name="merkMobil" class="form-control" placeholder="Merk Mobil" required>
                        </div>
                    </div>
...
<script>
    ...
    function edit(id_mobil_merk) {
        $.ajax({
            url: '<?= base_url($controller . '/getOne') ?>',
            type: 'post',
            data: {
                id_mobil_merk: id_mobil_merk
            },
            dataType: 'json',
            success: function(response) {
                // reset the form 
                ...
                $("#edit-form #idMobil").val(response.id_mobil_merk);
                $("#edit-form #merkMobil").val(response.nama_mobil_merk);
