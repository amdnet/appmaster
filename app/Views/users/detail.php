    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <form action="<?= base_url('users/editphoto/' . $detail['userid']); ?>" method="POST" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="photoLama" value="<?= $detail['photo']; ?>">
                            <div class="card card-primary card-outline">
                                <div class="card-body box-profile">
                                    ...
                                    <ul class="list-group list-group-unbordered mb-3">
                                        ...
                                        <li class="list-group-item">
                                            <b>Last Update</b> <a class="float-right"><?= $detail['updated_at']; ?></a>
                                        </li>
                                    </ul>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select id="role" name="role" class="custom-select">
                                                    <option value="" selected disabled required><?= $detail['name']; ?></option>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="email" id="email" name="email" class="form-control <?= ($validation->hasError('email')) ? 'is-invalid' : ''; ?>" placeholder="Email" value="<?= (old('email')) ? old('email') : $detail['email'] ?>">
                                                    <div class="input-group-prepend">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="telp" name="telp" class="form-control <?= ($validation->hasError('telp')) ? 'is-invalid' : ''; ?>" placeholder="Nomor handphone" value="<?= (old('telp')) ? old('telp') : $detail['telp'] ?>">
                                                    <div class=" input-group-prepend">
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-header p-2">
                                    <div class="card-body">
                                        ...
                                        <div class="d-grid gap-3 float-right">
                                            <button class="btn btn-dark btn-sm" type="submit" onclick="return confirm('Simpan perubahan data?')">Update password</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
